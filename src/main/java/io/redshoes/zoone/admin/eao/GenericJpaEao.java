...
public class GenericJpaEao<T, I> implements GenericEao<T, I>
{
	...
	public GenericJpaEao(Class<T> entityClass)
	{
	...
	public List<T> findByFilter(T entity) {
		...
		Example ex = Example.create(entity).excludeZeroes();
		
		Criteria criteria = session.createCriteria(entityClass).add(ex);
